...
-- เพิ่มคอลัมน์รูปภาพ/ไฟล์แนบสำหรับตารางส่งตรวจคุณภาพน้ำทุกไตรมาส (11 พารามิเตอร์ สธ.) หากยังไม่มี
ALTER TABLE IF EXISTS quarterly_water_quality ADD COLUMN IF NOT EXISTS lab_report_file TEXT DEFAULT NULL;
ALTER TABLE IF EXISTS quarterly_water_quality ADD COLUMN IF NOT EXISTS image_url TEXT DEFAULT NULL;
ALTER TABLE IF EXISTS quarterly_water_quality ADD COLUMN IF NOT EXISTS file_url TEXT DEFAULT NULL;

-- เพิ่มคอลัมน์รูปภาพ/ไฟล์แนบสำหรับตารางความเสี่ยงและเหตุการณ์ผิดปกติหากยังไม่มี
ALTER TABLE IF EXISTS risk_management ADD COLUMN IF NOT EXISTS image_url TEXT DEFAULT NULL;
ALTER TABLE IF EXISTS incident_records ADD COLUMN IF NOT EXISTS image_url TEXT DEFAULT NULL;
...
CREATE TABLE preliminary_water_quality (
    id TEXT PRIMARY KEY DEFAULT gen_random_uuid()::text,
    recorded_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    sampling_point VARCHAR(255) NOT NULL DEFAULT 'จุดปลายท่อออกจากระบบบำบัด',
...
CREATE TABLE quarterly_water_quality (
    ...
    sampling_point VARCHAR(255) NOT NULL DEFAULT 'จุดปลายท่อออกจากระบบบำบัดน้ำเสีย',
    ph NUMERIC(5, 2),
...
-- ============================================================================
-- SCHEMA ALIGNMENT (ALTER TABLE เพื่อรองรับคอลัมน์เพิ่มเติมอัตโนมัติ)
-- ============================================================================
ALTER TABLE IF EXISTS monthly_reports ADD COLUMN IF NOT EXISTS total_water_supply NUMERIC(12,2) DEFAULT 0.00;
ALTER TABLE IF EXISTS monthly_reports ADD COLUMN IF NOT EXISTS total_water_m3 NUMERIC(12,2) DEFAULT 0.00;
ALTER TABLE IF EXISTS monthly_reports ADD COLUMN IF NOT EXISTS daily_water_avg NUMERIC(12,2) DEFAULT 0.00;
ALTER TABLE IF EXISTS monthly_reports ADD COLUMN IF NOT EXISTS daily_wastewater_avg NUMERIC(12,2) DEFAULT 0.00;
ALTER TABLE IF EXISTS monthly_reports ADD COLUMN IF NOT EXISTS daily_kwh_avg NUMERIC(12,2) DEFAULT 0.00;
ALTER TABLE IF EXISTS monthly_reports ADD COLUMN IF NOT EXISTS status VARCHAR(50) DEFAULT 'verified';
ALTER TABLE IF EXISTS monthly_reports ADD COLUMN IF NOT EXISTS recorded_by VARCHAR(255) DEFAULT 'ระบบคำนวณอัตโนมัติ';
ALTER TABLE IF EXISTS monthly_reports ADD COLUMN IF NOT EXISTS approved_by VARCHAR(255);
ALTER TABLE IF EXISTS monthly_reports ADD COLUMN IF NOT EXISTS notes TEXT;

ALTER TABLE IF EXISTS preliminary_water_quality ADD COLUMN IF NOT EXISTS image_url TEXT;

ALTER TABLE IF EXISTS maintenance_records ADD COLUMN IF NOT EXISTS recorded_at TIMESTAMPTZ DEFAULT NOW();
ALTER TABLE IF EXISTS maintenance_records ADD COLUMN IF NOT EXISTS location VARCHAR(255) DEFAULT 'อาคารระบบบำบัดน้ำเสีย';
ALTER TABLE IF EXISTS maintenance_records ADD COLUMN IF NOT EXISTS equipment_list TEXT[] DEFAULT '{}';
ALTER TABLE IF EXISTS maintenance_records ADD COLUMN IF NOT EXISTS job_type VARCHAR(100) DEFAULT 'ป้องกัน';
ALTER TABLE IF EXISTS maintenance_records ADD COLUMN IF NOT EXISTS problem TEXT;
ALTER TABLE IF EXISTS maintenance_records ADD COLUMN IF NOT EXISTS cause TEXT;
ALTER TABLE IF EXISTS maintenance_records ADD COLUMN IF NOT EXISTS fix_method TEXT;
ALTER TABLE IF EXISTS maintenance_records ADD COLUMN IF NOT EXISTS fix_result TEXT DEFAULT 'ใช้งานได้ปกติ';
ALTER TABLE IF EXISTS maintenance_records ADD COLUMN IF NOT EXISTS cost NUMERIC(12,2) DEFAULT 0.00;
ALTER TABLE IF EXISTS maintenance_records ADD COLUMN IF NOT EXISTS operator VARCHAR(255);
ALTER TABLE IF EXISTS maintenance_records ADD COLUMN IF NOT EXISTS status VARCHAR(50) DEFAULT 'เสร็จสิ้น';
ALTER TABLE IF EXISTS maintenance_records ADD COLUMN IF NOT EXISTS remarks TEXT;
ALTER TABLE IF EXISTS maintenance_records ADD COLUMN IF NOT EXISTS image_url TEXT;
